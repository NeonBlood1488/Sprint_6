...
class MainPage(BasePage):
    ...
    @allure.step("Принять кукисы, если баннер отображается")
    ...
    def click_question(self, index):
        ...
        self.wait_for_visibility(answer_panel)   # Ждем появления панели с ответом
    ...
    def click_order_button_bottom(self):
        self.scroll_and_click(MainPageLocators.ORDER_BUTTON_BOTTOM)   # Прокручиваем к нижней кнопке, так как она может быть не в области видимости
